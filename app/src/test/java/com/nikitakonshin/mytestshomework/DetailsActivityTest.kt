...
class DetailsActivityTest {
    ...
    fun activityTextView_HasText() {
        scenario.onActivity {
            val totalCountTextView = it.findViewById<TextView>(R.id.totalCountTextView)
            assertEquals(MainActivityConst.NUMBER_OF_RESULT_ZERO_STRING, totalCountTextView.text)
        }
    }
    ...
    fun activityButtonIncrement_IsWorking() {
        scenario.onActivity {
            ...
            assertEquals(MainActivityConst.NUMBER_OF_RESULT_ONE_STRING, totalCountTextView.text)
        }
    }
    ...
    fun activityButtonDecrement_IsWorking() {
        scenario.onActivity {
            ...
            assertEquals(MainActivityConst.TEST_NUMBER_OF_RESULTS_MINUS_1, totalCountTextView.text)
        }
    }
